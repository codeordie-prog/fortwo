...
try:
    ...
    with col1:
        if image_bytes:
         st.image(io.BytesIO(image_bytes), width=60)
        else:
        ...
        with col2:  # Second column for the PDF generation section
            with st.expander("`Upload and download documents`", expanded=False):
                ...
                if file_name:
                    ...
                    clean_pdf = pdfgenerator.edit_the_generated_pdf(pdfbytesObj=pdf_file.decode())
                        ...
                        if user_input != None or audio_text!=None:
                            ...
                            if api_provider == "openai" and user_input or audio_text:
                                ...
                                if uploaded_chat_documents:
                                    ...
                                    query_with_context = f"{query_for_docs} context is : {docs_text}"
